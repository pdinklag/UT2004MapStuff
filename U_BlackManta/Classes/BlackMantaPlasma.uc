class BlackMantaPlasma extends Emitter;
...
defaultproperties
{
	Begin Object Class=SpriteEmitter Name=SpriteEmitter34
		...
		ColorScale(1)=(RelativeTime=1.000000,Color=(G=250,R=181))
	...
	Begin Object Class=SpriteEmitter Name=SpriteEmitter35
		...
		ColorScale(0)=(Color=(G=250,R=181))
		ColorScale(1)=(RelativeTime=1.000000,Color=(G=250,R=181))
		CoordinateSystem=PTCS_Relative
		MaxParticles=1
	...
	Begin Object Class=SpriteEmitter Name=SpriteEmitter36
		...
		ColorScale(1)=(RelativeTime=0.100000,Color=(B=155,G=254,R=148))
		ColorScale(2)=(RelativeTime=0.500000,Color=(B=57,G=238,R=61))
