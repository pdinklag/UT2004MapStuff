...
//
//-----------------------------------------------------------
class Arbalest extends ONSTreadCraft;

#exec OBJ LOAD FILE=U_Arbalest_rc.u PACKAGE=U_Arbalest
#exec OBJ LOAD FILE=..\Animations\ONSVehicles-A.ukx
#exec OBJ LOAD FILE=..\Sounds\ONSVehicleSounds-S.uax
#exec OBJ LOAD FILE=InterfaceContent.utx
#exec OBJ LOAD FILE=..\Textures\VMVehicles-TX.utx
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'ArbalestRocketLauncher',WeaponBone="TankCannonWeapon")
     RedSkin=Texture'U_Arbalest.Arbalest.ArbalestRed'
     BlueSkin=Texture'U_Arbalest.Arbalest.ArbalestBlue'
     ...
     VehiclePositionString="in an Arbalest"
     VehicleNameString="Arbalest"
